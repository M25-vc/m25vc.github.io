...
{name: "Leandro Jaime", title: "Analyst" ,desc: "Leandro is originally from Michoacán, Mexico, grew up in Joliet, IL, and graduated from Valparaiso University with a BSBA in Finance and minors in both Engineering and Mathematics. While at Valpo, he co-founded TEDxValparaisoUniversity, led Lambda Chi Alpha, and helped restart the Financial Management Association resulting in being recognized by the University and its president with the “Outstanding Leadership and Service” award. Most recently, Leandro was an associate with the Techstars Anywhere accelerator making it the best experience possible for the founders! Previously, he’s conducted due diligence with the Tech Coast Angels, organized conferences for Startup San Diego as MD of sponsorships, and conducted business development for a startup. In his free time, Leandro enjoys listening to podcasts, working out, and connecting others to potential opportunities." ,twitter: "https://twitter.com/LeandroJaime_" ,linkedin: "https://www.linkedin.com/in/leandrojaime/" ,medium: "" ,prev: "teamModal3" ,current: "teamModal4" ,next: "teamModal5" ,img: "img/team/leandro.jpg"},
