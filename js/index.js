...
function getAdvisorDetails(advisor) {
	return `<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 text-center advisors-item">
            ...
            <!-- Modal -->
            <div class="modal" id="${advisor.current}" tabindex="-1" role="dialog" aria-labelledby="advisorsModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body text-left">
                    <h6 class="font-weight-bold_2">${advisor.title}</h6>
                    <p>${advisor.desc}</p>
                  </div>
                  <div class="modal-footer">
