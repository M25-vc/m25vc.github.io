function getportfolioDetails(portfolio) {
	return `<a href="${portfolio.url}" target="_blank">
              <img class="item ${portfolio.class} isotope-item" src="img/portfolio/${portfolio.img}.jpg" alt="${portfolio.img}" style="position: absolute; left: 0px; top: 0px; margin:20px;">
            </a>`;
